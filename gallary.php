...
if(isset($_REQUEST['gets']))
{
 ...
 $sql="insert into gallary (type_id,name,image) values ('$type','$name','$img')";
...
{
  $id=$_REQUEST['delete'];
  $delt="delete from gallary where gallary_id='$id' ";
...
<table border="1" align="center" id="example">
    ...
    <tr>
        ...
        <td>
                  <a href="gallary.php?delete=<?php echo $data['gallary_id']; ?>" onclick="return confirm('are you sure this record delete?')"><i class="fa-solid fa-trash"></i></a> 
                  <i class="fa-solid fa-arrows-left-right"></i>
                  <a href="gallary_edit.php?edit=<?php echo $data['gallary_id']; ?>"><i class="fa-solid fa-pencil"></i></a>
            </td>
