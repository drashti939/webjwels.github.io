...
$sqli="select *from team ";
$getteam=mysqli_query($abc,$sqli);
?>
...
<!-- Mirrored from template.hasthemes.com/hiraola/hiraola/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Apr 2024 11:05:24 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>About Us || Hiraola - Jewellery eCommerce Bootstrap 5 Template</title>
    ...
    <div class="main-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="overview-img text-center img-hover_effect">
                            <a href="#">
                                <img class="img-full" src="images/goldaboutus.jpg" alt="Hiraola's About Us Image">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="team-area">
            <div class="container">
                ...
                <div class="row">
                    <?php
                     while($expert=mysqli_fetch_array($getteam))
                     {
                       ?>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member extra">
                            <div class="team-thumb img-hover_effect">
                                <a href="#">
                                    <img src="team_img/<?php echo $expert['image'];?>" alt="Our Team Member" class="extra">
                                </a>
                            </div>
                            <div class="team-content text-center">
                                <h3><?php echo $expert['username']; ?></h3>
                                <p><?php echo $expert['type']; ?></p>
                                <a href="#"><?php echo $expert['email']; ?></a>
...
<!-- Mirrored from template.hasthemes.com/hiraola/hiraola/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Apr 2024 11:05:26 GMT -->
</html>