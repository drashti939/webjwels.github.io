...
{
  $ids=$_REQUEST['edit'];  
  $xyz="select *from category where category_id='$ids' ";
...
if(isset($_REQUEST['gets']))
{
    ...
    if($img=='')
    {
        ...
        unlink('cat_img/'.$z['image']);
    }

 $sql="update category set type_id='$type', name='$name', image='$img' where category_id='$ids' ";
...
<div class="cate">Add Category Form</div>
    ...
    <div class="file1"><input type="file" class="text" name="image" ><img src="cat_img/<?php echo $z['image']; ?>" alt="" width="80px" height="80px"></div>
    </div>
    </div>
