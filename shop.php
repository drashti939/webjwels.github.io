...
if(isset($_REQUEST['cart_insert']))
{
   ...
   $sql="insert into cart (product_id,category_id,type_id,image,rate,qty,user_email,total) values ('$pro','$cat','$type','$img','$rate','$qty','$mail','$total')";
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <div class="single_product">
                                        ...
                                        <div class="hiraola-product_content">
                                            <div class="product-desc_info">
                                                <h6><a class="product-name" href="product_detail.php?cat=<?php echo $show['product_id']; ?>"><?php echo $show['name'];?></a></h6>
                                                <div class="price-box">
                                                ...
                                                <input type="hidden" name="stock" value="in stock">
                                                    ...
                                                    <ul>
                                                    <button type="submit" name="list_insert">
                                                        <li><a class="hiraola-add_compare" data-bs-toggle="tooltip" data-placement="top" title="Add To Wishlist"><i
                                ...
                                <div class="list-slide_item">
                                    <div class="single_product">
                                        ...
                                        <div class="hiraola-product_content">
                                            <div class="product-desc_info">
                                                <h6><a class="product-name" href="product_detail.php"><?php echo $show['name'];?></a></h6>
                                                <div class="rating-box">
                                                    <ul>
                                                        <li><i class="fa fa-star-of-david"></i></li>
                                                        <li><i class="fa fa-star-of-david"></i></li>
